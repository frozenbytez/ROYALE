    ...
    <div id="customCarouselExample" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="A" class="d-block w-100" alt="Venom">
            </div>
            <div class="carousel-item">
                <img src="Asset/images/deadpool.png" class="d-block w-100" alt="Deadpool">
            </div>
            <div class="carousel-item">
                <img src="Asset/images/weapoy.jpg" class="d-block w-100" alt="Humane">
            </div>
        </div>
...
<br> 
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between mb-3">
            <h3 class="x justify-content-center">
