    ...
    <div class="container">
        <div class="content d-flex align-items-center">
            <div class="image-container me-4">
                <img src="../pages/images/movie_674ef18862ab61.86818834.jpg" alt="asdasdas" class="img-fluid rounded" style="max-width: 300px;">
            </div>
            
            <div class="movie-info">
                <h1>asdasdas</h1>
                <p class="runtime">Runtime: sdadasd</p>
                <p>sadasdasd</p>
                <p class="director">Director: asdasdasd</p>
                <p class="cast">Cast: asdasdasdasd</p>
            ...
            <div class="col-lg-4 mt-3 mt-lg-0">
                <div class="receipt card p-4" style="background-color: #222; color: white; border-radius: 50px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="date-select" class="form-select"><option value="2024-12-23">December 23, 2024</option><option value="2024-12-24">December 24, 2024</option><option value="2024-12-25">December 25, 2024</option></select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="time-select" class="form-select">
                            ...
                            <option value="07:54">07:54 AM</option>
                            <option value="10:54">10:54 AM</option>
                        </select>
                    </div>
