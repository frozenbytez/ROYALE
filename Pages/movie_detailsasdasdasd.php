    ...
    <div class="container">
        <div class="content d-flex align-items-center">
            ...
            <div class="image-container me-4">
                <img src="../pages/images/movie_674ef1a20e95e6.94254680.jpg" alt="asdasdasd" class="img-fluid rounded" style="max-width: 300px;">
            </div>
            
            <!-- Movie Title and Description -->
            <div class="movie-info">
                <h1>asdasdasd</h1>
                <p class="runtime">Runtime: fvdfvdfvdfv</p>
                <p>asca</p>
                <p class="director">Director: dvfdvdf</p>
                <p class="cast">Cast: vdfvdfv</p>
            ...
            <div class="col-lg-4 mt-3 mt-lg-0">
                <div class="receipt card p-4" style="background-color: #222; color: white; border-radius: 50px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="date-select" class="form-select"><option value="2024-12-26">December 26, 2024</option><option value="2024-12-27">December 27, 2024</option><option value="2024-12-28">December 28, 2024</option></select>
                    </div>

                    <div class="mb-3">
                        <label for="time-select" class="form-label">Select Time:</label>
                        <select id="time-select" class="form-select">
                            <option value="07:58">07:58 AM</option>
