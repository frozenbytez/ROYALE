    ...
    <div class="container">
        <div class="content d-flex align-items-center">
            <div class="image-container me-4">
                <img src="../pages/images/movie_674ef02b05a150.05073362.jpg" alt="asasa" class="img-fluid rounded" style="max-width: 300px;">
            </div>
            
            <div class="movie-info">
                <h1>asasa</h1>
                <p class="runtime">Runtime: as</p>
                <p>sasa</p>
                <p class="director">Director: sas</p>
                <p class="cast">Cast: asas</p>
                ...
                <div class="receipt card p-4" style="background-color: #222; color: white; border-radius: 50px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="time-select" class="form-select">
                            ...
                            <option value="09:48">09:48 AM</option>
                            <option value="07:51">07:51 AM</option>
                        </select>
                    </div>
