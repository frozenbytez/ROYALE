    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div class ="container-fluid">
            <a class="navbar-brand fs-4" href="home.html">
              ...
              </a>            <button class="navbar-toggler shadow-none border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
    ...
    <div class="row movie-section align-items-center">
        ...
        <div class="col-md-6 d-flex flex-column align-items-center">
            ...
            <div class="trailer-link-container mt-3">
                <a href="#" src="https://youtu.be/73_1biulkYk?si=U6QuDQLH2epAKsP-"class="trailer-link">Watch Trailer</a>
            </div>
