    ...
    <div class="container">
        <div class="content d-flex align-items-center">
            ...
            <div class="image-container me-4">
                <img src="../pages/images/movie_674853323e3933.91584360.jpg" alt="WADADW" class="img-fluid rounded" style="max-width: 300px;">
            </div>
            ...
            <div class="movie-info">
                ...
                <p>waDDAW</p>
                <p class="director">Director: ADW</p>
                <p class="cast">Cast: AWDD</p>
                ...
                <div class="receipt card p-4" style="background-color: #222; color: white; border-radius: 50px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="time-select" class="form-select">
                            <option value="19:29">07:29 PM</option>
                            <option value="19:53">07:53 PM</option>
                            <option value="19:23">07:23 PM</option>
                        </select>
                    </div>
