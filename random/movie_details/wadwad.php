    ...
    <div class="container">
        <div class="content d-flex align-items-center">
            ...
            <div class="image-container me-4">
                <img src="../pages/images/movie_6748418a3ef340.05947525.jpg" alt="WadwAD" class="img-fluid rounded" style="max-width: 300px;">
            </div>
            
            <!-- Movie Title and Description -->
            <div class="movie-info">
                <h1>WadwAD</h1>
                <p class="runtime">Runtime: 1hr and 20mins</p>
                <p>WDAWD</p>
                <p class="director">Director: Carl</p>
                <p class="cast">Cast: Echavez</p>
            ...
            <div class="col-lg-4 mt-3 mt-lg-0">
                <div class="receipt card p-4" style="background-color: #222; color: white; border-radius: 50px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="date-select" class="form-select"><option value="2024-11-28">November 28, 2024</option></select>
                    </div>

                    <div class="mb-3">
                        <label for="time-select" class="form-label">Select Time:</label>
                        <select id="time-select" class="form-select">
                            <option value="18:13">06:13 PM</option>
                            <option value="18:16">06:16 PM</option>
                            <option value="18:43">06:43 PM</option>
                        </select>
                    </div>
