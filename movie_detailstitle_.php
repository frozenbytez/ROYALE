    ...
    <div class="container">
        <div class="content d-flex align-items-center">
            ...
            <div class="image-container me-4">
                <img src="../pages/images/movie_6748463dd82fa4.18509904.jpg" alt="Title " class="img-fluid rounded" style="max-width: 300px;">
            </div>
            
            <!-- Movie Title and Description -->
            <div class="movie-info">
                <h1>Title </h1>
                <p class="runtime">Runtime: apwokdKOPAWDOKPdwa</p>
                ...
                <div class="receipt card p-4" style="background-color: #222; color: white; border-radius: 50px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="time-select" class="form-select">
                            ...
                            <option value="18:36">06:36 PM</option>
                        </select>
                    </div>
